...
[![Maturity](https://github.com/giellalt/lang-tkl/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-tkl/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-tkl/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-tkl/typosreport/)
...
[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-tkl?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-tkl?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-tkl?platform=mobile&channel=nightly)
...
This repository contains finite state source files for the Tokelauan language,
for building morphological analysers, proofing tools
and dictionaries. The data and implementation are licenced under __LICENCE__
licence, also detailed in the
[LICENSE](https://github.com/giellalt/lang-tkl/blob/main/LICENSE). The
authors named in the AUTHORS file are available to grant other licencing
choices.

Install proofing tools and [keyboards](https://github.com/giellalt/keyboard-tkl)
for the Tokelauan language by using the [Divvun Installer](http://divvun.no)
...
- [Language specific documentation](https://giellalt.github.io/lang-tkl/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Tokelauan language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/lang-tkl
```

Using Subversion:
```
svn checkout https://github.com/giellalt/lang-tkl.git/trunk lang-tkl
```

Building and installation
-------------------------

[INSTALL](https://github.com/giellalt/lang-tkl/blob/main/INSTALL)
